...
//     watchlistMovieBloc.emit(WatchlistMovieHasData([tMovie]));
...
//     WidgetTester tester,
//   ) async {
//     watchlistMovieBloc.emit(WatchlistMovieLoading());
//     when(
//       mockGetWatchlistMovies.execute(),
...
//     WidgetTester tester,
//   ) async {
//     watchlistMovieBloc.emit(WatchlistMovieError('Error message'));
//     when(
//       mockGetWatchlistMovies.execute(),
//     ).thenAnswer((_) async => const Right([]));
...
//     WidgetTester tester,
//   ) async {
//     watchlistMovieBloc.emit(WatchlistMovieEmpty());
//     when(
//       mockGetWatchlistMovies.execute(),
//     ).thenAnswer((_) async => const Right([]));
//     when(mockTvNotifier.watchlistState).thenReturn(RequestState.loaded);
